// Calcular a resistência que um resistor provém //

function resistor() {

    let cor1, cor2, cor3, cor4, prefixoOhm
    ...
    switch(id){
        ...
        case 5:
            cor1 = parseInt(prompt("Digite a cor da primeira faixa:\n- 0 para preto\n- 1 para marrom\n- 2 para vermelho\n- 3 para laranja\n- 4 para amarelo\n- 5 para verde\n- 6 para azul\n- 7 para violeta\n- 8 para cinza\n- 9 para branco")*100);
            cor5 = parseInt(prompt("Digite a cor da segunda faixa:\n- 0 para preto\n- 1 para marrom\n- 2 para vermelho\n- 3 para laranja\n- 4 para amarelo\n- 5 para verde\n- 6 para azul\n- 7 para violeta\n- 8 para cinza\n- 9 para branco")*10);
            cor2 = parseInt(prompt("Digite a cor da terceira faixa:\n- 0 para preto\n- 1 para marrom\n- 2 para vermelho\n- 3 para laranja\n- 4 para amarelo\n- 5 para verde\n- 6 para azul\n- 7 para violeta\n- 8 para cinza\n- 9 para branco"));
